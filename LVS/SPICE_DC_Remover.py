...
df_lines.insert(1, '.include "/content/conda-env/share/pdk/sky130A/libs.ref/sky130_fd_sc_hd/spice/sky130_fd_sc_hd.spice"\n')
df_lines.insert(1, '.include "/content/RyanCaginalp_CDC/LVS/transmission_gate.spice"\n')
